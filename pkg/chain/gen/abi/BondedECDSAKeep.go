...
// BondTokenAddress is a free data retrieval call binding the contract method 0x1133fd2c.
//
// Solidity: function bondTokenAddress() constant returns(address)
...
//
// Solidity: function bondTokenAddress() constant returns(address)
func (_BondedECDSAKeep *BondedECDSAKeepSession) BondTokenAddress() (common.Address, error) {
	return _BondedECDSAKeep.Contract.BondTokenAddress(&_BondedECDSAKeep.CallOpts)
}

// BondTokenAddress is a free data retrieval call binding the contract method 0x1133fd2c.
//
// Solidity: function bondTokenAddress() constant returns(address)
func (_BondedECDSAKeep *BondedECDSAKeepCallerSession) BondTokenAddress() (common.Address, error) {
	return _BondedECDSAKeep.Contract.BondTokenAddress(&_BondedECDSAKeep.CallOpts)
}
...
// ReturnPartialSignerBonds is a paid mutator transaction binding the contract method 0xc36bc456.
//
// Solidity: function returnPartialSignerBonds(uint256 _amount) returns()
func (_BondedECDSAKeep *BondedECDSAKeepTransactor) ReturnPartialSignerBonds(opts *bind.TransactOpts, _amount *big.Int) (*types.Transaction, error) {
	return _BondedECDSAKeep.contract.Transact(opts, "returnPartialSignerBonds", _amount)
}

// ReturnPartialSignerBonds is a paid mutator transaction binding the contract method 0xc36bc456.
//
// Solidity: function returnPartialSignerBonds(uint256 _amount) returns()
func (_BondedECDSAKeep *BondedECDSAKeepSession) ReturnPartialSignerBonds(_amount *big.Int) (*types.Transaction, error) {
	return _BondedECDSAKeep.Contract.ReturnPartialSignerBonds(&_BondedECDSAKeep.TransactOpts, _amount)
}

// ReturnPartialSignerBonds is a paid mutator transaction binding the contract method 0xc36bc456.
//
// Solidity: function returnPartialSignerBonds(uint256 _amount) returns()
func (_BondedECDSAKeep *BondedECDSAKeepTransactorSession) ReturnPartialSignerBonds(_amount *big.Int) (*types.Transaction, error) {
	return _BondedECDSAKeep.Contract.ReturnPartialSignerBonds(&_BondedECDSAKeep.TransactOpts, _amount)
}
